import { canTransition, localesFor } from "@navitas/contracts";
import type {
  AgentEvent,
  AuditReport,
  AuditStatus,
...
const STORE_KEY = "navitas.fixture.audits.v1";
...
function buildReport(input: IntakeInput, degraded: boolean): AuditReport {
  ...
  return {
    ...
    limitations: [
      ...
      "Screenshots document the audited state; navitas.ai does not modify your site.",
      ...(degraded
